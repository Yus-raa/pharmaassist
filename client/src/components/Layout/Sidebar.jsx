...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* SIDEBAR */}
      <aside className="fixed left-0 top-0 h-full w-80 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-2xl z-50 animate-in slide-in-from-left duration-300">
        ...
        {/* FOOTER */}
        <div className="absolute bottom-0 left-0 w-full p-5 border-t border-gray-200 dark:border-gray-800">
